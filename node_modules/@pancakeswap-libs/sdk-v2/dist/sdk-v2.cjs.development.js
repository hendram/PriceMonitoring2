...
const url = "https://bsc.getblock.io/mainnet/?api_key=c0a9c311-ebf0-4264-bf6b-9c17571341db";
...
const providerm = new ethers.providers.JsonRpcProvider(url);
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      if (provider === undefined) provider = providerm;
